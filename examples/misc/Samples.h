...
float fInp2[3] = {0,1,0};
float fInp3[3] = {0,0,1};
float fInp4[3] = {0.9,0,0.7};
float fInp5[3] = {1,0,1};
float fInp6[3] = {0,1,0};
float fInp7[3] = {0,1,0};
float fInp8[3] = {0,1,0};
float fInp9[3] = {0,1,0};
float fInp10[3] = {0,1,0};
////////////////////////////////////////////////////////
////////////////////////////////////////////////////////
...
float fOut5[6] = {0, 0, 0, 0, 1, 0};
float fOut6[6] = {0, 0, 0, 0, 0, 1};
float fOut7[6] = {0, 0, 0, 0, 0.1, 1};
float fOut8[6] = {0, 0, 0, 0, 0.2, 1};
float fOut9[6] = {0, 0, 0, 0, 0.3, 1};
float fOut10[6] = {0, 0, 0, 0, 0.4, 1};
////////////////////////////////////////////////////////
////////////////////////////////////////////////////////
float ared[3] 		= {1,0,0};
